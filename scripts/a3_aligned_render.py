"""Aligned A3 diagram renderer — reads labels from qos-architecture-diwakar-tundlam.md."""
...
def _slide01_content_size() -> Tuple[float, float]:
    ...
    if not groups:
        raise ValueError("Slide 1 needs *group* blocks in qos-architecture-diwakar-tundlam.md")
    program = groups[0][1]

...
Diagrams are **not** built from Mermaid. Labels and layout come from `dt100/bugatti-qos-architecture.md`; PNGs are rendered by `scripts/a3_aligned_render.py` (PyMuPDF).
